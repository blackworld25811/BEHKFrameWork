...
public class Canvas : Singleton<Canvas>
{
   ...
   public class Sub_Label
   {
      ...
      public Sub_LocalPositionBinding_Image LocalPositionBinding_Image;

   public class Sub_LocalPositionBinding_Image
   {
      public GameObject GameObject;
   }

      public Sub_LocalRotationBinding_Image LocalRotationBinding_Image;

   public class Sub_LocalRotationBinding_Image
   {
      public GameObject GameObject;
   }

      public Sub_LocalScaleBinding_Image LocalScaleBinding_Image;

   public class Sub_LocalScaleBinding_Image
   {
      public GameObject GameObject;
   }
   }
